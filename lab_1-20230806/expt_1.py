...
class expt_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self.blocks_vector_source_x_0 = blocks.vector_source_f((262, 262, 294, 262, 349, 330, 262, 262, 294, 262, 392, 349, 262, 262, 440, 392, 349, 329, 277, 466, 466, 440, 349, 392, 349), True, 1, [])
        self.blocks_vco_f_0 = blocks.vco_f(samp_rate, 6.8, 0.1)
        self.blocks_repeat_0 = blocks.repeat(gr.sizeof_float*1, samp_rate)

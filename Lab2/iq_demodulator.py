...
class iq_demodulator(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.samp_rate_0 = samp_rate_0 = 500000
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_float*1, '/media/sf_EE340/Lab2/data1.dat', True, 0, 0)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_sig_source_x_2, 0), (self.blocks_multiply_xx_2_0, 0))
        self.connect((self.blocks_file_source_0, 0), (self.blocks_multiply_xx_2_0, 1))
        self.connect((self.blocks_multiply_xx_2_0, 0), (self.low_pass_filter_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(10, self.samp_rate, 45000, 1000, window.WIN_HAMMING, 6.76))
